...
//
//public class LocationServiceJAva extends Service  {
//
...
////            Loc loc = new Gson().fromJson(json, Loc::class.java)
...
//                bumpDetector = new BumpDetector(this, onBumpDetect);
//            }
//
...
//                LocalBroadcastManager.getInstance(LocationServiceJAva.this).sendBroadcast(intent);
...
//            if (LocationServiceJAva.class.getName().equals(service.service.getClassName())) {
//                return true;
//            }
//        }
//        return false;
